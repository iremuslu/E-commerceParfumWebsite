    ...
    <div class="col">
        ...
        <div class="card reg_style">
            ...
            <div  class="card-header card-header-color text_color" align="center">
                <H4 style="font-size: 30px; font-weight:bold;">Login For Admin</H4>
            </div>

            <div class="card-body card-body-color text_body">
                <form  method = "post">
                    <div class="form-group">
                        <label style="background-color:#F9CEEE;" for="email">E-mail</label>
                    ...
                    <div align="center">
                        <input style="background-color:orange;" type="submit" name="btn_login" class="btn btn-success" value="Login">
                    </div>
            ...
            <div class="card-footer card-footer-color" align="center" >
                <div style="font-size: 15px; font-weight:bold;">Are you a  <a href="login.php">customer </a> ?</div>
            </div>
